...
class HomeController {
    ...
    async addPostReaction(req, res) {
        ...
        const newReaction = await homeService.addPostReaction(post_id, user_id, reaction_type, emoji_char);
        new SuccessResponse({
    ...
    async removePostReaction(req, res) {
        const id = req.params.id;
        const deleteResult = await homeService.removePostReaction(id);
        new SuccessResponse({
    ...
    async getPostReactions(req, res) {
        ...
        const reactions = await homeService.getPostReactions(post_id);
        new SuccessResponse({
